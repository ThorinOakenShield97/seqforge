...
- Molecule-aware sequence validation

- RNA translation and ORF detection

- RNA reverse-complement support

- Protein amino acid statistics

- Molecule-aware CLI commands

- Molecule type support across literal, FASTA, and FASTQ analysis
